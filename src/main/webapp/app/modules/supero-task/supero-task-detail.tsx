...
export class SuperoTaskDetail extends React.Component<ISuperoTaskDetailProps> {
  ...
  render() {
    const { superoTaskEntity, match } = this.props;
    return (
      <Row>
        <Col md="8">
          <h2>
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <Translate contentKey={`superoApp.TaskStatus.${superoTaskEntity.status}`} />
            </dd>
            <dt>
            ...
            <dd>
              {superoTaskEntity.updateDate ? <TextFormat type="date" value={superoTaskEntity.updateDate} format={APP_DATE_FORMAT} /> : ''}
            </dd>
            <dt>
            ...
            <dd>
              {superoTaskEntity.completionDate ? (
                <TextFormat type="date" value={superoTaskEntity.completionDate} format={APP_DATE_FORMAT} />
              ) : (
                ''
              )}
            </dd>
          ...
          &nbsp;
          <Button tag={Link} to={`${match.url}/${superoTaskEntity.id}/edit`} replace color="primary">
